...
Last updated: 2026-03-12 (scan h — full triage complete, 6 networks published)

## Session State

- **Last active**: 2026-03-12 (scan h: first successful MCP-based triage run; bioRxiv API and NDEx both working)
- **Current task**: None
...
### Networks Published 2026-03-12 scan h (first successful MCP-direct triage run)

| Network | NDEx UUID | Date | Type | Tier |
|---------|-----------|------|------|------|
| ndexagent biorxiv-daily-scan 2026-03-12 | 80212c0f-1e3a-11f1-94e8-005056ae3c32 | 2026-03-12 | analysis | 1 |
| ndexagent biorxiv-review TenVIP-seq IAV RdRP pausing | 13bbe281-1e3b-11f1-94e8-005056ae3c32 | 2026-03-12 | analysis | 2 |
| ndexagent biorxiv-review DDX3X IFN-beta translation | 21b0baf3-1e3b-11f1-94e8-005056ae3c32 | 2026-03-12 | analysis | 2 |
| ndexagent biorxiv-review arenavirus aberrant genomes RIG-I | 3064ebc5-1e3b-11f1-94e8-005056ae3c32 | 2026-03-12 | analysis | 2 |
| ndexagent biorxiv-analysis TenVIP-seq TRIM25 RdRp pausing | e9cbd797-1e3b-11f1-94e8-005056ae3c32 | 2026-03-12 | analysis | 3 |
| ndexagent biorxiv-highlight TenVIP-seq TRIM25 RdRp | f9678239-1e3b-11f1-94e8-005056ae3c32 | 2026-03-12 | announcement | 3 |
...
## Scan Log: 2026-03-12 scan h (eighth run — scheduled task)

- **Scan method**: bioRxiv MCP API (direct — egress proxy now resolved; first fully successful API-based triage)
- **NDEx**: Authenticated and working (credentials resolved)
- **Papers found at Tier 1**: 13 new papers (scan window 2026-03-09 to 2026-03-12)
- **Papers reviewed at Tier 2**: 3 (scoring >= 0.6)
- **Papers analyzed at Tier 3**: 1 (must_read)
- **Networks published to NDEx**: 6 (all PUBLIC)

### Tier 1 Papers Scored

| DOI | Title | Score | Tier 2 |
|-----|-------|-------|--------|
| 10.1101/2025.01.08.631631 | TenVIP-seq: IAV RdRp pausing landscape (TRIM25 KO effect) | 0.78 | yes |
| 10.64898/2026.03.08.707086 | DDX3X promotes IFN-beta translation via IFNB1 5-UTR binding (SeV) | 0.75 | yes |
| 10.64898/2026.03.09.710519 | Arenavirus aberrant mini-genomes activate RIG-I | 0.65 | yes |
| 10.64898/2026.03.06.710055 | HIV-1 Vpr counteracts TASOR restriction via CRL4-DCAF1 | 0.35 | no |
| 10.1101/2025.03.14.643374 | ISG endotype heterogeneity / immunometabolic axis (COVID-19) | 0.30 | no |
| 10.64898/2026.03.08.710362 | Stochastic model: virus-IFN speed vs reliability | 0.15 | no |
| 10.64898/2026.03.09.709174 | Anomaly detection for antigen-specific TCRs | 0.15 | no |
| 10.64898/2026.02.27.708643 | SLC9A1 macrophage innate activation (cardiac) | 0.10 | no |
| 10.64898/2026.03.10.710544 | CD8 T cells / type 1 IFN in HIV-TB meningitis | 0.10 | no |
| 10.64898/2026.03.08.710399 | Vitamin A / RAR shapes intestinal antimicrobial defense | 0.10 | no |
| 10.64898/2026.03.08.710424 | Vaccinia J5 EFC structure | 0.10 | no |
| 10.64898/2026.01.03.697434 | LP.8.1 COVID-19 mRNA booster antibodies | 0.05 | no |
| 10.1101/2025.08.06.668254 | Q-MOL in silico drug discovery platform | 0.05 | no |

### Tier 2 Reviews

1. **TenVIP-seq / TRIM25-RdRp (must_read)**: TRIM25 KO globally reduces IAV RdRp pausing. TRIM25 has dual role: RIG-I ubiquitination (established) + RdRp pausing promotion (new). NS1/TRIM25 interaction now has two-layer significance. Network: 13bbe281
2. **DDX3X / IFN-beta (worth_discussing)**: DDX3X directly binds IFNB1 5-UTR, promotes IFN-beta translation. PAR-CLIP in SeV-infected human cells. Translational regulation of innate signaling. Network: 21b0baf3
3. **Arenavirus NVGs / RIG-I (worth_discussing)**: Small non-standard viral genomes activate RIG-I in New World arenaviruses (parallel to IAV mvRNAs). Old World viruses evade by suppressing NVG production. Network: 3064ebc5

### Tier 3 Analysis

1. **TenVIP-seq / TRIM25-RdRp**: 14-node, 14-edge molecular interaction network. Maps full TRIM25 dual-role circuit: polymerase pausing + RIG-I activation + NS1 immune evasion. Open questions: direct TRIM25-RdRp binding? TRIM25 ubiquitination of RdRp subunits? Overlap between pause sites and mvRNA generation sites? Analysis: e9cbd797; Highlight: f9678239
...
| 10.1101/2025.01.08.631631 | TenVIP-seq: IAV RdRp pausing (TRIM25) | TRIM25 KO reduces RdRp pausing globally; TRIM25 dual role: RIG-I ubiquitination + polymerase pausing; favipiravir intensifies pausing | scan_2026-03-12/tier1_scan_h.json |
| 10.64898/2026.03.08.707086 | DDX3X promotes IFN-beta translation (SeV) | DDX3X binds IFNB1 5-UTR directly; promotes IFN-beta translation; PAR-CLIP; SeV model | scan_2026-03-12/tier1_scan_h.json |
| 10.64898/2026.03.09.710519 | Arenavirus aberrant genomes activate RIG-I | NVGs activate RIG-I (parallel to IAV mvRNAs); Old World arenaviruses suppress NVG production to evade innate sensing | scan_2026-03-12/tier1_scan_h.json |
...
- **Scan h breakthrough**: First fully successful triage run using the bioRxiv MCP API directly (egress proxy resolved). NDEx credentials also working. Both infrastructure issues that plagued scans a-g are resolved. Backlog of unpublished networks from 2026-03-10 through 2026-03-12 scans f/g was published separately.
- **TRIM25 dual-role discovery**: The TenVIP-seq paper (scan h must_read) reveals TRIM25 as a host modulator of IAV RdRp pausing — a completely new function independent of its established role in RIG-I K63-ubiquitination. NS1 binding TRIM25 thus has two simultaneous effects: blocking innate sensing AND potentially altering polymerase pausing dynamics. This is potentially the most significant single finding in the HPMI group's recent scan history, connecting the NS1/TRIM25 immune evasion story to viral polymerase regulation.
- **Cross-scan connection (TRIM25 × mvRNAs)**: The mvRNA/RIG-I paper (Science Advances 2026, from 2025 bioRxiv scan) showed mvRNAs are generated at specific sites during RdRp replication. The TenVIP-seq paper maps RdRp pausing sites. An open question: are the pause sites where TRIM25 acts the same sites that generate mvRNAs? If so, TRIM25 could be involved in both polymerase regulation and immune sensing of aberrant replication products.
- **DDX3X connection**: DDX3X is a DEAD-box helicase that promotes IFN-beta translation (scan h, worth_discussing). DDX3X has also been studied as an IAV host factor (replication-promoting role) and as a potential antiviral drug target. The dual role parallels the TRIM25 story — host factors co-opted for multiple functions in viral infection.
- **Arenavirus NVG/RIG-I generalization**: The arenavirus aberrant genome paper validates the mvRNA/RIG-I paradigm across RNA virus families. Old World arenaviruses evade by suppressing aberrant genome production — analogous to how IAV NS1 suppresses the sensing of mvRNAs through TRIM25 inhibition.
- **Infrastructure note**: bioRxiv search_recent_papers with interval_days=3 and max_results>20 still tends to timeout. Reliable parameters: interval_days=2-3 with max_results=15-20. Multiple keyword searches are needed to cover the full config keyword set.
